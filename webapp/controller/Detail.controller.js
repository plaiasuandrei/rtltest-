...
this.getOwnerComponent().oListSelector.clearMasterListSelection();
			...
			var sPath = oElementBinding.getPath(), oResourceBundle = this.getResourceBundle(), oObject = oView.getModel().getObject(sPath), sObjectId = oObject.Document, sObjectName = oObject.RdVendorName, oViewModel = this.getModel("detailView");
