sap.ui.define([
		...
		opaTest("MasterList Filtering on Wrbtr less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("<Wrbtr>").
		...
		opaTest("MasterList Filtering on Wrbtr more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 <Waers>").
				and.iPressOKInViewSelectionDialog();
