sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("rtl/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("rtl.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["rtl/localService/mockserver"], function (mockserver) {
